...
<div class="container_styled_1">
	...
	<div class="container margin_60_35">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<h1 class="text-dark text-center">TERMINOS &amp; CONDICIÓNES DE USO</h1><br>
...
<section id="">
	...
	<div class="container margin_60">
		<div class="main_title">
			...
			<h3 class="">Terminos &amp; Condiciónes</h3>
			<p>
			...
			<p>
				El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. www.anana.mx no asume la responsabilidad en caso de que entregue dicha clave a terceros.
			</p>
			...
			<h3 class="">LICENCIA</h3>
			<p>Anana a través de su sitio web concede una licencia para que los usuarios utilicen los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>

			<h3 class="">USO NO AUTORIZADO</h3>
			...
			<h3 class="">POLÍTICA DE REEMBOLSO Y GARANTÍA</h3>
			...
			<h3 class="">COMPROBACIÓN ANTIFRAUDE</h3>
			...
			<p>Este sitio web www.anana.mx garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.

				La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.

				Anana reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
